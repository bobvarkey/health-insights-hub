    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border bg-card/50 px-6 py-5">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold tracking-tight">GLP-1 / GIP Obesity Algorithm</h1>
        </div>
        <p className="mt-1 text-sm text-muted-foreground">
          Evidence-based obesity pharmacotherapy with GLP-1 receptor agonists and dual agonists
        </p>
      </header>
